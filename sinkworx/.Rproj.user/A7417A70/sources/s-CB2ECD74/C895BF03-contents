...
#'@usage sink_rfu(database_rfu, size = 3, shape = 6, colour = "darkgreen", fill = "white",
...
#'@examples
#' sink_rfu(database_rfu, size = 4, shape = 1, colour = "blue", export_output = TRUE, save_as = "Sinking_Plots.pdf")

# ----------------------------------------------------------------------------------

sink_rfu <- function(database_rfu, size = 3, shape = 6, colour = "darkgreen", fill = "white",
                     export_output = FALSE, save_as = "Sinking_RFU.pdf") {
